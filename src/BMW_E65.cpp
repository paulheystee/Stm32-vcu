...
////////////////////////////////////////////////////////////////////////////////////////////////////
void BMW_E65Class::DecodeCAN(int id, uint32_t* data)
{
...
void BMW_E65Class::SendAbsDscMessages(bool Brake_In)
{
...
bool BMW_E65Class::GetGear(Vehicle::gear& outGear)
{
